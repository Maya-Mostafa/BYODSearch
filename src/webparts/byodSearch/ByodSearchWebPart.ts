...
import * as strings from 'ByodSearchWebPartStrings';
import ByodSearch from './components/ByodSearch';
import { IByodSearchProps } from './components/IByodSearchProps';
...
export default class ByodSearchWebPart extends BaseClientSideWebPart<IByodSearchWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IByodSearchProps> = React.createElement(
      ByodSearch,
      {
